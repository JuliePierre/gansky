...
ActiveRecord::Schema.define(version: 20170622130214) do
  ...
  create_table "flat_facilities", force: :cascade do |t|
    t.integer  "flat_id"
    t.integer  "facility_id"
    t.integer  "number"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["facility_id"], name: "index_flat_facilities_on_facility_id", using: :btree
    t.index ["flat_id"], name: "index_flat_facilities_on_flat_id", using: :btree
  end
